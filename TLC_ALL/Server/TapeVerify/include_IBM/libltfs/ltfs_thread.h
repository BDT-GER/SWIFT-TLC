...
static inline int ltfs_thread_cond_destroy(ltfs_thread_cond_t *cond)
{
	...
	//static inline int ltfs_thread_cond_init(ltfs_thread_cond_t *restrict cond) //TODO
	static inline int ltfs_thread_cond_init(ltfs_thread_cond_t *cond)
{
	return pthread_cond_init(cond, NULL);
}

//static inline int ltfs_thread_cond_timedwait(ltfs_thread_cond_t *restrict cond,  //TODO
//											 ltfs_thread_mutex_t *restrict mutex,
static inline int ltfs_thread_cond_timedwait(ltfs_thread_cond_t *cond,
											 ltfs_thread_mutex_t *mutex,
											 const int sec)
{
	struct timeval now;
...
//static inline int ltfs_thread_cond_wait(ltfs_thread_cond_t *restrict cond, //TODO
//										ltfs_thread_mutex_t *restrict mutex)
static inline int ltfs_thread_cond_wait(ltfs_thread_cond_t *cond,
										ltfs_thread_mutex_t *mutex)
{
