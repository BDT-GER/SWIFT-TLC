...
namespace ltfs_management
{
	...
	FormatThread::FormatThread(void* manager, const string& barcode, FormatType type, int priority, time_t startTimeInMicroSecs):
		manager_(manager), barcode_(barcode), type_(type), priority_(priority), status_(FORMAT_THREAD_STATUS_WAITING), timeStart_(startTimeInMicroSecs)
	{
