...
int  dcache_cache_exists(const char *name, bool *exists, bool *dirty, struct ltfs_volume *vol);
int  dcache_set_workdir(const char *workdir, struct ltfs_volume *vol);
int  dcache_get_workdir(char **workdir, struct ltfs_volume *vol);
int  dcache_load(const char *name, struct ltfs_volume *vol);
int  dcache_unload(struct ltfs_volume *vol);
