 ...
 */
int ltfs_fsops_close(struct dentry *d, bool dirty, bool use_iosched, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an unexpected error occurred
 */
int ltfs_fsops_unlink(const char *path, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an unexpected error occurred
 */
int ltfs_fsops_rename(const char *from, const char *to, struct ltfs_volume *vol);
 ...
 */
int ltfs_fsops_getattr_path(const char *path, struct dentry_attr *attr, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an unexpected error occurred.
 */
int ltfs_fsops_listxattr(const char *path, char *list, size_t size, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an unexpected error occurred.
 */
int ltfs_fsops_removexattr(const char *path, const char *name, struct ltfs_volume *vol);
 ...
 */
int ltfs_fsops_utimens_path(const char *path, const struct ltfs_timespec ts[2], struct ltfs_volume *vol);
 ...
 */
int ltfs_fsops_set_readonly_path(const char *path, bool readonly, struct ltfs_volume *vol);
 ...
 */
int ltfs_fsops_truncate_path(const char *path, off_t length, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an internal error or device write error occurred.
 */
int ltfs_fsops_symlink_path(const char* to, const char* from, struct ltfs_volume *vol);
 ...
 *    - Another negative value if an internal error or device write error occurred.
 */
int ltfs_fsops_readlink_path(const char* path, char* buf, size_t size, struct ltfs_volume *vol);
 ...
 * @param vol LTFS volume.
 * @return 0 if success, or a negetive value on error
 */
