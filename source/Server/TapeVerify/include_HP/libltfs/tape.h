...
int64_t tape_get_max_blocksize(struct device_data *dev);
...
/*
int set_tape_attribute(struct ltfs_volume *vol, struct tape_attr *t_attr);
...
int tape_load_all_attribute_from_cm(struct device_data *dev, struct tape_attr *t_attr);
