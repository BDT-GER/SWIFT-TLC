...
namespace ltfs_management
{
	...
	FormatThread*
	FormatManager::StartFormat(const string& barcode, FormatType type, int priority, Labels& labels, time_t startTimeInMicroSecs, bool bRequested)
	{
		boost::lock_guard<boost::mutex> lock(mutex_);


		FormatThread* formatThread = new FormatThread(this, barcode, type, priority, startTimeInMicroSecs, bRequested);
